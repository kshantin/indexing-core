module.exports = class Data1678789961226 {
    name = 'Data1678789961226'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "event" ("id" character varying NOT NULL, "event_log" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "user_id" character varying, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`)
